...
title: "Results"
description: |
  I will cover several functions of the LTM and showcase some shiny apps for simulations! Click *Show Code* for the implementation. :)
code_folding: true
---
...
<iframe src="https://wx-zhu.shinyapps.io/LTM_simulation/" class="l-body-outset shaded" height="1000px"></iframe>
...
Please be patient as the algorithm may take a few minutes to run.

<iframe src="https://wx-zhu.shinyapps.io/LTM_greedy/" class="l-body-outset shaded" height="1000px"></iframe>
